            ...
            <motion.div className="h-[350px] px-4 w-full md:w-[500px] md:px-0 pt-20">
              <div className="border rounded-lg p-6 flex flex-col gap-4 text-zinc-500 text-sm dark:text-zinc-400 dark:border-zinc-700">
                <p className="flex flex-row justify-center gap-4 items-center text-zinc-900 dark:text-zinc-50">
                  <VercelIcon size={16} /><span className="text-xl">Mind Sparks Ai Project</span> <MasonryIcon />
                </p>
                <p>
                Mind Sparks AI Project & Digital Agency: Inovasi AI yang Dilengkapi dengan Solusi Digital untuk Keunggulan Kompetitif Anda
                </p>
                <p>
                  {" "}
                  Learn more about {" "}
                  <Link
                    ...
                    href="https://mind-sparks-blog.vercel.app/"
                    target="_blank"
                  >
                    MindSparks{" "}
                  </Link>.
